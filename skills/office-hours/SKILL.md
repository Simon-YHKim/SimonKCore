...
preamble-tier: 3
version: 2.0.0
description: "Use when asked to \"brainstorm this\", \"아이디어 있어\", \"help me think through this\", \"office hours\", or \"is this worth building\". Proactively invoke this skill when the user describes a new product idea, asks whether something is worth building, or wants to think through design decisions before any code. Produces a design doc via YC-style forcing questions (Startup mode) or design thinking brainstorm (Builder mode)."
allowed-tools:
  - Bash
  - Read
  - Grep
